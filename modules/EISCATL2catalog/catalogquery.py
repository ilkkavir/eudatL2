class CatalogQuery:
        """ 
        Queries to  MySQL file catalogue system (DB: disk_archive or tape_archive)
        """
        # Class hiding all MySQL disk_archive opening and querying from main program
        ...
        def __init__(self, config):
                ...
                # Make connection to DB. deposit: tape_archive data1: disk_archive
                #try:
                ...
                #except:
                #        raise IOError("Could not connect to DB")

        # enter, exit, with... syntax ensures proper closing
        def __enter__(self):
                return self
